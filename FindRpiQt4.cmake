...
function(_QT4_QUERY_QMAKE_REAL VAR RESULT)
...
function(_QT4_QUERY_QMAKE VAR RESULT)
  ...
  if(NOT root)
    message(FATAL_ERROR "Local Raspbian root is not known. Please, specify "
                        "either RPI_RASPBIAN_ROOT or ENV{RPI_RASPBIAN_ROOT}.")
  endif()

  set(override_QT_INSTALL_PREFIX        "${root}/usr")
  set(override_QT_INSTALL_DATA          "${root}/usr/share/qt4")
  set(override_QT_INSTALL_HEADERS       "${root}/usr/include/qt4")
  set(override_QT_INSTALL_LIBS          "${root}/usr/lib/arm-linux-gnueabihf")
  set(override_QT_INSTALL_PLUGINS       "${root}/usr/lib/arm-linux-gnueabihf/qt4/plugins")
  set(override_QT_INSTALL_IMPORTS       "${root}/usr/lib/arm-linux-gnueabihf/qt4/imports")
  set(override_QT_INSTALL_TRANSLATIONS  "${root}/usr/share/qt4/translations")
  set(override_QT_INSTALL_CONFIGURATION "${root}/etc/xdg")
  set(override_QT_INSTALL_EXAMPLES      "${root}/usr/lib/qt4/examples")
  set(override_QT_INSTALL_DEMOS         "${root}/usr/lib/qt4/demos")
  set(override_QMAKE_MKSPECS            "${root}/usr/share/qt4/mkspecs")

  set(value "${override_${VAR}}")
  if(value)
    file(TO_CMAKE_PATH "${value}" value)
    set(${RESULT} ${value} PARENT_SCOPE)
  else()
    _qt4_query_qmake_real(${VAR} value)
    set(${RESULT} ${value} PARENT_SCOPE)
  endif()
endfunction()
